        ...
        <div>
            {
                services.length === 0 &&
                <div role="status">
                    <svg aria-hidden="true" class="mr-2 w-8 h-8 text-gray-100 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
